					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO posts(title, content, img) VALUE('".$_POST['p_title']."','".$_POST['p_content']."','".$fnew."')";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="p_title" class="form-control" placeholder="Заголовк">
                                                   </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Информация</label>
                                                    <input type="text" name="p_content" class="form-control form-control-danger" placeholder="Текст">
                                                    </div>
                                            </div>
                                        </div>
                                        <div class="row p-t-20">
